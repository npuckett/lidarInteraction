...
//websockets
WebsocketClient webData;
String serverURL = "ws://robotsocket.herokuapp.com/";
...
webData = new WebsocketClient(this, serverURL);
}
...
dataSender.send(true,true,lidarPoints1.currentBlobs,kps,sensorZones,tZone);
