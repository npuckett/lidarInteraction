/* autogenerated by Processing revision 1292 on 2023-04-16 */
...
public class lidarTrackingServer_v065 extends PApplet {
...
public void send(boolean sendOSC, boolean sendWebSocket, ArrayList<TrackBlob> allBlobs, ArrayList<KeyPoint> allKeyPoints, ArrayList<SensorZone> allSensorZones, TrackPoly theTrackPoly)
{
...
public void display(float drawScale, boolean drawName, boolean drawPoints, boolean drawBox, boolean drawHistory, int fColor)
{
...
PolyPoint(int _x, int _y)
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "lidarTrackingServer_v065" };
    if (passedArgs != null) {
