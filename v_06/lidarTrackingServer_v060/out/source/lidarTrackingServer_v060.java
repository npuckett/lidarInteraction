/* autogenerated by Processing revision 1292 on 2023-04-14 */
...
public class lidarTrackingServer_v060 extends PApplet {
...
PolyPoint(int _x, int _y)
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "lidarTrackingServer_v060" };
    if (passedArgs != null) {
